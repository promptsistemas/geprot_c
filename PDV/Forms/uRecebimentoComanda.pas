...
begin
  if Application.MessageBox('Deseja Importar Mesa/Comanda?','Atenção!!',MB_YESNO+MB_ICONQUESTION) = idyes then
  begin
   try
...
//      if Application.MessageBox('Deseja Importar Mais Mesa/Comanda?','Confirmação',MB_YESNO+MB_ICONQUESTION)= IDYES then
//      begin
//        DM.cdsPDV.Refresh;
//        DM.cdsItemPdv.Refresh;
//        PesquisaMesa;
