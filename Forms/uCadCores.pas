...
begin
  ...
  begin
    ShowMessage('Código de Cor Já Cadastrado Para Essa Tinturaria.');
    DBEdit3.Text:= '';
...
begin
  ...
  if Tipo = 'Edit' then
  begin
    if Campo <> DM.cdsCoresCODIGO.AsString then
      VerificaCores;
...
begin
  ...
  begin
    ShowMessage('Favor Informar Código');
    DBEdit1.SetFocus;
    Exit;
  end;
  if DBEdit2.Text = '' then
  begin
    ShowMessage('Favor Informar Descrição da Cor');
    DBEdit2.SetFocus;
    Exit;
  end;
  if Tipo = 'Insert' then
