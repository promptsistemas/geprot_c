object frmFechamento: TfrmFechamento
  ...
  object Panel2: TPanel
    ...
    object L_COMPRA_MATERIA: TLabel
      Left = 560
      Top = 6
      Width = 105
      Height = 13
      Caption = 'L_COMPRA_MATERIA'
      Visible = False
    end
    object L_COMPRA_MATERIA_TOTAL: TLabel
      Left = 568
      Top = 26
      Width = 105
      Height = 13
  ...
  object Panel4: TPanel
    ...
    object Label7: TLabel
      ...
      Height = 23
      Align = alCustom
      Caption = 'Rela'#231#227'o de Faturamentos'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -17
      Font.Name = 'Segoe UI'
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      Caption = 'TabSheet1'
      object QR_FECHAMENTO: TRLReport
        Left = 33
        Top = 13
        Width = 794
        Height = 1123
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Title = 'Relat'#243'rio de Fechamento'
        object RLBand1: TRLBand
          ...
          object RLLabel1: TRLLabel
            ...
            Width = 392
            Height = 24
            Caption = 'Composi'#231#227'o de Custo de Malha Acabada'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlack
            Font.Height = -20
            Font.Name = 'Arial'
        ...
        object RLSubDetail1: TRLSubDetail
          ...
          object RLBand5: TRLBand
            ...
            object RLL_VALOR_TOTAL: TRLLabel
              Left = 121
              Top = 8
              Width = 49
              Height = 16
        ...
        object RLSubDetail2: TRLSubDetail
          ...
          object RLBand10: TRLBand
            ...
            object RLL_CUSTO_TOTAL: TRLLabel
              Left = 578
              Top = 3
              Width = 49
              Height = 16
          ...
          object RLBand11: TRLBand
            ...
            object RLL_COMPRA_MATERIA: TRLLabel
              Left = 351
              Top = 3
              Width = 107
              Height = 16
            ...
            object RLL_COMPRA_MATERIA_TOTAL: TRLLabel
              Left = 578
              Top = 3
              Width = 49
              Height = 16
          ...
          object RLBand12: TRLBand
            ...
            object RLL_PERCENTUAL: TRLLabel
              Left = 649
              Top = 23
              Width = 25
              Height = 16
            ...
            object RLLabel19: TRLLabel
              ...
              Width = 207
              Height = 16
              Caption = 'Quebra no Processo estamparia'
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clRed
              Font.Height = -13
              Font.Name = 'Arial'
            ...
            object RLL_TOTAL_CUSTO_QUERA: TRLLabel
              Left = 578
              Top = 23
              Width = 49
              Height = 16
            ...
            object RLLabel20: TRLLabel
              ...
              Width = 193
              Height = 16
              Caption = 'Quebra no Processo malharia'
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clRed
              Font.Height = -13
              Font.Name = 'Arial'
            ...
            object RLL_PERCENTUAL_E: TRLLabel
              Left = 649
              Top = 3
              Width = 25
              Height = 16
          ...
          object RLBand13: TRLBand
            ...
            object RLLabel21: TRLLabel
              ...
              Width = 229
              Height = 18
              Caption = 'Custo total da Malha Acabada'
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clBlack
              Font.Height = -16
              Font.Name = 'Arial'
            ...
            object RLL_CUSTO_TOTAL_MALAHA_ACABADA: TRLLabel
              Left = 400
              Top = 4
              Width = 49
              Height = 16
            ...
            object RLL_SOMA_CUSTO_TOTAL: TRLLabel
              Left = 577
              Top = 4
              Width = 49
              Height = 16
  ...
  object cdsServicos: TClientDataSet
    ...
    object cdsServicosQUANT: TFMTBCDField
      DisplayLabel = 'Quant'
      FieldName = 'QUANT'
      Precision = 18
      Size = 4
    end
    object cdsServicosTOTAL: TFMTBCDField
      DisplayLabel = 'Total'
      FieldName = 'TOTAL'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
    ...
    object cdsServicosCUSTO: TFMTBCDField
      DisplayLabel = 'Custo'
      FieldName = 'CUSTO'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
  ...
  object qServicos: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      ' SELECT  st.valor,  s.descricao, '
      ...
      'WHERE C.id_grupo_empresa = 3'
      'AND F.id_fornecedor = 7'
      'AND RP.dt_emissao BETWEEN '#39'01/01/2020'#39'  AND '#39'12/31/2020'#39
      ')AS QUANT, '
      
        'ST.valor *  ( SELECT sum(IR.quant_faturado) FROM tb_item_remessa' +
        '_producao IR '
      'JOIN tb_remessa_producao RP ON (RP.id_remessa = IR.id_remessa)'
      'JOIN tb_cliente C ON (C.id_cliente = RP.id_cliente)           '
      'JOIN tb_fornecedor F ON (F.id_fornecedor = RP.id_forn_tint) '
      ...
      'JOIN tb_servico S ON (S.id_servico = ST.id_servico) '
        ...
        'JOIN tb_preco_tinturaria P ON (P.id_preco_tinturaria = ST.id_pre' +
        'co_tinturaria)'
      
        'JOIN tb_grupo_empresa G ON (G.id_grupo_empresa = P.id_grupo_empr' +
        'esa)'
      'WHERE G.id_grupo_empresa = 3'
      'AND P.id_fornecedor = 7')
    SQLConnection = DM.conexao
    Left = 496
    Top = 50
    object qServicosVALOR: TFMTBCDField
      FieldName = 'VALOR'
      Precision = 18
      Size = 4
    end
    ...
    object qServicosQUANT: TFMTBCDField
      FieldName = 'QUANT'
      Precision = 18
      Size = 4
    end
    object qServicosTOTAL: TFMTBCDField
      FieldName = 'TOTAL'
      Precision = 18
    end
    object qServicosCUSTO: TFMTBCDField
      FieldName = 'CUSTO'
      Precision = 18
      Size = 12
    end
  ...
  object cdsNotas: TClientDataSet
    ...
    Left = 480
    Top = 107
    object cdsNotasID_ITEM_PRODUCAO: TIntegerField
      FieldName = 'ID_ITEM_PRODUCAO'
      Required = True
    end
    object cdsNotasID_PRODUCAO: TIntegerField
      FieldName = 'ID_PRODUCAO'
    end
    object cdsNotasID_MATERIA_PRIMA: TIntegerField
      FieldName = 'ID_MATERIA_PRIMA'
    end
    object cdsNotasQUANT_FATURADO: TFMTBCDField
      DisplayLabel = 'Quant.'
      FieldName = 'QUANT_FATURADO'
      Precision = 18
      Size = 4
    end
    object cdsNotasVL_UNIT: TFMTBCDField
    ...
    object cdsNotasVL_TOTAL: TFMTBCDField
    ...
    object cdsNotasVL_UNIT_REAL: TFMTBCDField
    ...
    object cdsNotasVL_TOTAL_REAL: TFMTBCDField
      FieldName = 'VL_TOTAL_REAL'
      Precision = 18
      Size = 2
    end
    object cdsNotasQUANT_PROD: TFMTBCDField
    ...
    object cdsNotasFORNECEDOR: TStringField
      DisplayLabel = 'Fornecedor'
      FieldName = 'FORNECEDOR'
      Size = 50
    end
    object cdsNotasNR_NOTA_FISCAL: TIntegerField
      DisplayLabel = 'N'#186' Nota Fiscal'
      FieldName = 'NR_NOTA_FISCAL'
    end
    object cdsNotasNR_NF_REMESSA: TIntegerField
      FieldName = 'NR_NF_REMESSA'
    end
    object cdsNotasNOME_MATERIA: TStringField
      DisplayLabel = 'Mat'#233'ria-Prima'
      FieldName = 'NOME_MATERIA'
      Size = 30
    end
    object cdsNotasDT_EMISSAO: TDateField
      DisplayLabel = 'Data Emiss'#227'o'
      FieldName = 'DT_EMISSAO'
    end
    object cdsNotasID_FORNECEDOR: TIntegerField
      FieldName = 'ID_FORNECEDOR'
      Required = True
    end
    object cdsNotasID_FORN_REM: TIntegerField
  ...
  object qNotas: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'JOIN tb_fornecedor F ON (F.id_fornecedor = RP.id_forncedor)'
        ...
        ')'
      'WHERE RP.id_cliente = 3'
      'AND RP.dt_emissao between '#39'07/24/2020'#39' and '#39'08/31/2020'#39)
    SQLConnection = DM.conexao
    Left = 416
    Top = 107
    object qNotasID_ITEM_PRODUCAO: TIntegerField
      FieldName = 'ID_ITEM_PRODUCAO'
      Required = True
    end
    object qNotasID_PRODUCAO: TIntegerField
      FieldName = 'ID_PRODUCAO'
    end
    object qNotasID_MATERIA_PRIMA: TIntegerField
      FieldName = 'ID_MATERIA_PRIMA'
    end
    object qNotasQUANT_FATURADO: TFMTBCDField
      FieldName = 'QUANT_FATURADO'
      Precision = 18
      Size = 4
    end
    object qNotasVL_UNIT: TFMTBCDField
      FieldName = 'VL_UNIT'
      Precision = 18
      Size = 2
    end
    object qNotasVL_TOTAL: TFMTBCDField
      FieldName = 'VL_TOTAL'
      Precision = 18
      Size = 2
    end
    object qNotasVL_UNIT_REAL: TFMTBCDField
      FieldName = 'VL_UNIT_REAL'
      Precision = 18
      Size = 2
    end
    object qNotasVL_TOTAL_REAL: TFMTBCDField
      FieldName = 'VL_TOTAL_REAL'
      Precision = 18
      Size = 2
    end
    object qNotasQUANT_PROD: TFMTBCDField
      FieldName = 'QUANT_PROD'
      Precision = 18
      Size = 2
    end
    object qNotasCLIENTE: TStringField
      FieldName = 'CLIENTE'
      Size = 50
    end
    object qNotasFORNECEDOR: TStringField
      FieldName = 'FORNECEDOR'
      Size = 50
    end
    object qNotasNR_NOTA_FISCAL: TIntegerField
      FieldName = 'NR_NOTA_FISCAL'
    end
    object qNotasNR_NF_REMESSA: TIntegerField
      FieldName = 'NR_NF_REMESSA'
    end
    object qNotasNOME_MATERIA: TStringField
      FieldName = 'NOME_MATERIA'
      Size = 30
    end
    object qNotasDT_EMISSAO: TDateField
      FieldName = 'DT_EMISSAO'
    end
    object qNotasID_FORNECEDOR: TIntegerField
      FieldName = 'ID_FORNECEDOR'
      Required = True
    end
    object qNotasID_FORN_REM: TIntegerField
      FieldName = 'ID_FORN_REM'
      Required = True
    end
  end
  ...
  object cdsFaturamento: TClientDataSet
    ...
    Left = 240
    Top = 139
    object cdsFaturamentoMyColumn1: TStringField
      FieldName = 'MyColumn1'
      Required = True
      FixedChar = True
      Size = 10
    end
    object cdsFaturamentoFORNECEDOR: TStringField
      DisplayLabel = 'Fornecedor'
      FieldName = 'FORNECEDOR'
      Size = 50
    end
    object cdsFaturamentoNR_NOTA_FISCAL: TIntegerField
      DisplayLabel = 'N'#186' Nota Fiscal'
      FieldName = 'NR_NOTA_FISCAL'
    end
    object cdsFaturamentoDT_EMISSAO: TDateField
      DisplayLabel = 'Data Emiss'#227'o'
      FieldName = 'DT_EMISSAO'
    end
    object cdsFaturamentoVL_NOTA: TFMTBCDField
  ...
  object qFaturamento: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'SELECT '#39'FIO'#39', p.nr_nota_fiscal, p.dt_emissao, p.vl_nota, F.nome ' +
        'AS FORNECEDOR'
      ' FROM tb_producao p '
      ' JOIN TB_CLIENTE C ON (C.ID_CLIENTE = P.ID_CLIENTE)'
      ' JOIN tb_fornecedor F ON (F.id_fornecedor = P.id_forncedor)'
      ' WHERE C.ID_GRUPO_EMPRESA = 4'
      ' AND P.dt_emissao between '#39'01/01/2000'#39
      ' AND '#39'01/01/2021'#39
      ' AND P.id_forn_rem = 7'
      '  union '
      
        '  SELECT '#39'MALHARIA'#39', rp.nr_nota_fiscal, rp.dt_emissao, rp.vl_not' +
        'a, F.nome AS FORNECEDOR'
      '  FROM tb_remessa_producao Rp '
      ' JOIN TB_CLIENTE C ON (C.ID_CLIENTE = RP.ID_CLIENTE)'
      '  JOIN tb_fornecedor F ON (F.id_fornecedor = RP.id_for_remessa)'
      '  WHERE C.ID_GRUPO_EMPRESA = 4'
      '  AND RP.NF_QUEBRA = '#39'N'#39
      '  AND RP.dt_emissao between '#39'01/01/2000'#39
      ' AND '#39'01/01/2021'#39
      '  AND RP.id_forn_tint = 7'
      ''
      '  union '
      
        '  SELECT '#39'TINTURARIA'#39', t.NR_NOTA_REMESSA, t.dt_emissao, t.vl_not' +
        'a, F.nome AS FORNECEDOR'
      ...
      ' JOIN TB_CLIENTE C ON (C.ID_CLIENTE = T.ID_CLIENTE)'
        ...
        ') '
      '  WHERE C.ID_GRUPO_EMPRESA = 4'
      '  AND t.dt_emissao between '#39'01/01/2000'#39
      ' AND '#39'01/01/2021'#39
      '  AND T.ID_FOR_TINTURARIA = 7')
    SQLConnection = DM.conexao
    Left = 176
    Top = 139
    object qFaturamentoMyColumn1: TStringField
      FieldName = 'MyColumn1'
      Required = True
      FixedChar = True
      Size = 10
    end
    object qFaturamentoNR_NOTA_FISCAL: TIntegerField
      FieldName = 'NR_NOTA_FISCAL'
    end
    object qFaturamentoDT_EMISSAO: TDateField
      FieldName = 'DT_EMISSAO'
    end
    object qFaturamentoVL_NOTA: TFMTBCDField
      FieldName = 'VL_NOTA'
      Precision = 18
      Size = 3
    end
    object qFaturamentoFORNECEDOR: TStringField
      FieldName = 'FORNECEDOR'
      Size = 50
    end
  end
  ...
  object cdsNotaQuebra: TClientDataSet
    ...
    Left = 240
    Top = 172
    object cdsNotaQuebraMyColumn1: TStringField
      FieldName = 'MyColumn1'
      Required = True
      FixedChar = True
      Size = 10
    end
    object cdsNotaQuebraFORNECEDORE: TStringField
      DisplayLabel = 'Fornecedor'
      FieldName = 'FORNECEDORE'
      Size = 50
    end
    ...
    object cdsNotaQuebraDT_EMISSAO: TDateField
      DisplayLabel = 'Dt Emiss'#227'o'
      FieldName = 'DT_EMISSAO'
    end
    object cdsNotaQuebraVL_NOTA: TFMTBCDField
  ...
  object qNotaQuebra: TSQLQuery
    ...
    SQL.Strings = (
      'SELECT'
      ' '#39'MALHARIA'#39','
      ' F.NOME AS FORNECEDORE,'
      ' R.NR_NOTA_FISCAL,'
      ' R.DT_EMISSAO,'
      ' R.VL_NOTA'
      'FROM TB_REMESSA_PRODUCAO R'
      'join tb_fornecedor F ON (F.id_fornecedor = R.ID_FOR_REMESSA)'
      'WHERE R.ID_CLIENTE = 3'
      'AND R.DT_EMISSAO BETWEEN '#39'07/24/2020'#39' AND '#39'08/31/2020'#39
      'AND R.NF_QUEBRA = '#39'S'#39
      'UNION'
      'SELECT'
      ' '#39'TINTURARIA'#39','
      ' F.NOME AS FORNECEDOR,'
      ...
      'WHERE NR.ID_CLIENTE = 3'
      'AND T.DT_EMISSAO BETWEEN '#39'07/24/2020'#39' AND '#39'08/31/2020'#39
      'GROUP BY'
      ' F.NOME ,'
      ' NR.NR_NOTA_RETORNO,'
      ' T.DT_EMISSAO')
    ...
    Left = 176
    Top = 172
    object qNotaQuebraMyColumn1: TStringField
      FieldName = 'MyColumn1'
      Required = True
      FixedChar = True
      Size = 10
    end
    object qNotaQuebraFORNECEDORE: TStringField
      FieldName = 'FORNECEDORE'
      Size = 50
    end
    ...
    object qNotaQuebraDT_EMISSAO: TDateField
      FieldName = 'DT_EMISSAO'
    end
    object qNotaQuebraVL_NOTA: TFMTBCDField
      FieldName = 'VL_NOTA'
      Precision = 18
      Size = 6
    end
  ...
  object RLPDFFilter1: TRLPDFFilter
    DocumentInfo.Title = 'Geprot'
    DocumentInfo.Creator = 
      'FortesReport Community Edition v4.0 \251 Copyright '#169' 1999-2016 F' +
      'ortes Inform'#225'tica'
    FileName = 'C:\Users\Marcio\Desktop\fechamento.pdf'
    DisplayName = 'Documento PDF'
    Left = 751
    Top = 116
  end
  object dsQuebraEstamparia: TDataSource
    DataSet = cdsQuebraEstamparia
    Left = 712
    Top = 150
  end
  object cdsQuebraEstamparia: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspQuebraEstamparia'
    Left = 680
    Top = 150
    object cdsQuebraEstampariaID_REMESSA: TIntegerField
      FieldName = 'ID_REMESSA'
      Required = True
    end
    object cdsQuebraEstampariaID_FORN_TINT: TIntegerField
      FieldName = 'ID_FORN_TINT'
      Required = True
    end
    object cdsQuebraEstampariaID_CLIENTE: TIntegerField
      FieldName = 'ID_CLIENTE'
    end
    object cdsQuebraEstampariaQUANT_NF: TFMTBCDField
      FieldName = 'QUANT_NF'
      Precision = 18
      Size = 3
    end
    object cdsQuebraEstampariaVL_NOTA: TFMTBCDField
      FieldName = 'VL_NOTA'
      DisplayFormat = '###,###0.00'
      EditFormat = '###,###0.00'
      Precision = 18
    ...
    object cdsQuebraEstampariaNR_NOTA_FISCAL: TIntegerField
      FieldName = 'NR_NOTA_FISCAL'
    end
    object cdsQuebraEstampariaQUANT_FATURADO: TFMTBCDField
      FieldName = 'QUANT_FATURADO'
      DisplayFormat = '###,###0.000'
      EditFormat = '###,###0.000'
      Precision = 18
  ...
  object dspQuebraEstamparia: TDataSetProvider
    DataSet = qQuebraEstamparia
    Options = [poIncFieldProps, poAllowMultiRecordUpdates, poAutoRefresh, poAllowCommandText, poUseQuoteChar]
    Left = 648
    Top = 150
  end
  object qQuebraEstamparia: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      
        'SELECT  NQ.ID_REMESSA,  nq.ID_FORN_TINT ,nq.ID_CLIENTE, nq.QUANT' +
        '_NF, nq.VL_NOTA, nq.NR_NOTA_FISCAL, IR.QUANT_FATURADO'
      'FROM TB_REMESSA_PRODUCAO NQ'
      
        'join TB_ITEM_REMESSA_PRODUCAO ir on (IR.ID_REMESSA = NQ.ID_REMES' +
        'SA)'
      'JOIN TB_CLIENTE C ON (C.ID_CLIENTE = NQ.ID_CLIENTE)'
      'WHERE C.ID_GRUPO_EMPRESA = 3'
      'AND nq.ID_FORN_TINT = 7'
      'AND IR.QUANT_FATURADO <> 52'
      'AND nq.DT_EMISSAO BETWEEN '#39'01/01/2020'#39' and '#39'12/31/2020'#39
      'AND NQ.NF_QUEBRA = '#39'S'#39
      
        'GROUP BY  NQ.ID_REMESSA,  nq.ID_FORN_TINT ,nq.ID_CLIENTE, nq.QUA' +
        'NT_NF, nq.VL_NOTA, nq.NR_NOTA_FISCAL, IR.QUANT_FATURADO')
    SQLConnection = DM.conexao
    Left = 616
    Top = 150
    object qQuebraEstampariaID_REMESSA: TIntegerField
      FieldName = 'ID_REMESSA'
      Required = True
    end
    object qQuebraEstampariaID_FORN_TINT: TIntegerField
      FieldName = 'ID_FORN_TINT'
      Required = True
    end
    object qQuebraEstampariaID_CLIENTE: TIntegerField
      FieldName = 'ID_CLIENTE'
    end
    object qQuebraEstampariaQUANT_NF: TFMTBCDField
      FieldName = 'QUANT_NF'
      Precision = 18
      Size = 3
    end
    object qQuebraEstampariaVL_NOTA: TFMTBCDField
      FieldName = 'VL_NOTA'
      Precision = 18
      Size = 2
    end
    object qQuebraEstampariaNR_NOTA_FISCAL: TIntegerField
      FieldName = 'NR_NOTA_FISCAL'
    end
    object qQuebraEstampariaQUANT_FATURADO: TFMTBCDField
      FieldName = 'QUANT_FATURADO'
      Precision = 18
      Size = 4
    end
