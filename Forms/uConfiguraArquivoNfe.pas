...
uses
 IniFiles, ShellAPI, pcnRetConsReciDFe,pcnConversao,pcnNFe, pcnAuxiliar,
  ...
  Spin, Vcl.Imaging.jpeg,ACBrDFeSSL, System.TypInfo, ACBrDFeReport,
  ACBrDFeDANFeReport;
...
procedure TfrmConfiguraArquivoNFe.PathClick(Sender: TObject);
var
  Dir: string;
begin
...
procedure TfrmConfiguraArquivoNFe.sbPathCanClick(Sender: TObject);
begin
 PathClick(edtPathCan);
end;

procedure TfrmConfiguraArquivoNFe.sbPathCCeClick(Sender: TObject);
begin
 PathClick(edtPathCCe);
end;

procedure TfrmConfiguraArquivoNFe.sbPathDPECClick(Sender: TObject);
begin
 PathClick(edtPathDPEC);
end;

procedure TfrmConfiguraArquivoNFe.sbPathEventoClick(Sender: TObject);
begin
 PathClick(edtPathEvento);
end;

procedure TfrmConfiguraArquivoNFe.sbPathInuClick(Sender: TObject);
begin
 PathClick(edtPathInu);
end;

procedure TfrmConfiguraArquivoNFe.sbPathNFeClick(Sender: TObject);
begin
...
procedure TfrmConfiguraArquivoNFe.sbtnPathSalvarClick(Sender: TObject);
begin
...
procedure TfrmConfiguraArquivoNFe.SpeedButton2Click(Sender: TObject);
begin
  DM.cdsEmpresa.Open;

  Pesquisa(DM.cdsEmpresa,['R_SOCIAL','FANTASIA'],
                         ['',''],[35,35],'','0','','Empresa','Empresa','Empresa');

  edtEmitCNPJ.Text                    := DM.cdsEmpresaCNPJ.AsString;
  edtEmitIE.Text                      := DM.cdsEmpresaINS_EST.AsString;
  edtEmitRazao.Text                   := DM.cdsEmpresaR_SOCIAL.AsString;
  edtEmitFantasia.Text                := DM.cdsEmpresaFANTASIA.AsString;
  edtEmitFone.Text                    := DM.cdsEmpresaTELEFONE.AsString;
  ...
  edtEmitComp.Text                    := DM.cdsEmpresaCOMPLEMENTO.AsString;
  edtEmitBairro.Text                  := DM.cdsEmpresaBAIRRO.AsString;
  edtEmitCodCidade.Text               := DM.cdsEmpresaCODIGO_MUNIC.AsString;
  edtEmitCidade.Text                  := DM.cdsEmpresaCIDADE.AsString;
  edtEmitUF.Text                      := DM.cdsEmpresaUF.AsString;

end;

procedure TfrmConfiguraArquivoNFe.spPathSchemasClick(Sender: TObject);
begin
