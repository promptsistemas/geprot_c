object frmCadTransportadora: TfrmCadTransportadora
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsNone
  Caption = 'Cadastro de Tranportadora'
  ClientHeight = 471
  ClientWidth = 664
  Color = 13034239
  ...
  object P_DADOS: TPanel
    ...
    object DBEdit2: TDBEdit
      ...
      DataField = 'CNPJ'
      DataSource = DM.dsTransportadora
      TabOrder = 0
