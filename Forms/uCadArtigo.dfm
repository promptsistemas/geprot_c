object frmCadArtigo: TfrmCadArtigo
  Left = 404
  Top = 175
  BorderIcons = [biSystemMenu]
  BorderStyle = bsNone
  Caption = 'Cadastro de Artigo'
  ClientHeight = 541
  ClientWidth = 645
  Color = 13034239
    ...
    object TabSheet1: TTabSheet
      ...
      object Panel2: TPanel
        ...
        object Label12: TLabel
          ...
          Width = 234
          Height = 23
          Caption = 'MAT'#201'RIA-PRIMA DO ARTIGO'
          Font.Charset = ANSI_CHARSET
          Font.Color = clYellow
          Font.Height = -17
          Font.Name = 'Segoe UI'
      ...
      object DBGrid1: TDBGrid
        ...
        Color = 15399890
        Ctl3D = False
        DataSource = DM.dsMateriaPrimaArtigo
      ...
      object P_PRODUTOS: TPanel
        ...
        object DBEdit5: TDBEdit
          ...
          ParentCtl3D = False
          TabOrder = 2
          OnExit = BB_GRAVAR2Click
          OnKeyPress = FormKeyPress
        end
      end
    end
    object Acabamento: TTabSheet
      Caption = 'Acabamento'
      ImageIndex = 1
      ...
      object P_ACABAMENTO1: TPanel
        ...
        BorderStyle = bsSingle
        TabOrder = 1
        object BB_INCLUIR_ACAB: TBitBtn
          Left = 3
          Top = 9
          Width = 75
          Height = 25
          ...
          NumGlyphs = 2
          TabOrder = 0
          OnClick = BB_INCLUIR_ACABClick
        end
        object BB_EDIT_ACAB: TBitBtn
          Left = 3
          Top = 35
          Width = 75
          Height = 25
          ...
          NumGlyphs = 2
          TabOrder = 1
          OnClick = BB_EDIT_ACABClick
        end
        object BB_CANC_ACAB: TBitBtn
          Left = 3
          Top = 62
          Width = 75
          Height = 25
          ...
          NumGlyphs = 2
          TabOrder = 2
          OnClick = BB_CANC_ACABClick
        end
        object BB_GRAVAR_ACAB: TBitBtn
          Left = 3
          Top = 88
          Width = 75
          Height = 25
          ...
          NumGlyphs = 2
          TabOrder = 3
          OnClick = BB_GRAVAR_ACABClick
        end
        object BB_EXC_ACAB: TBitBtn
          Left = 3
          Top = 113
          Width = 75
          Height = 25
      ...
      object DBGrid3: TDBGrid
        ...
        Color = 16377557
        Ctl3D = False
        DataSource = DM.dsAcabamentoArtigo
        DrawingStyle = gdsClassic
        FixedColor = 15794175
        GradientEndColor = clWhite
        GradientStartColor = clBlue
  ...
  object qMateriaPrima: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'FROM TB_MATERIA_PRIMA MP'
        ...
        'WHERE NOT EXISTS(SELECT MA.ID_MATERIA_PRIMA FROM TB_MATERIA_PRIM' +
        'A_ARTIGO MA'
      
        '                 WHERE MA.ID_MATERIA_PRIMA = MP.ID_MATERIA AND M' +
        'A.ID_ARTIGO = :ID_ARTIGO)')
    SQLConnection = DM.conexao
    Left = 456
    Top = 204
    object qMateriaPrimaID_MATERIA: TIntegerField
      FieldName = 'ID_MATERIA'
      Required = True
    end
    object qMateriaPrimaNOME_MATERIA: TStringField
      FieldName = 'NOME_MATERIA'
      Size = 30
    end
    object qMateriaPrimaPERC_FIO: TFMTBCDField
      FieldName = 'PERC_FIO'
      Precision = 18
      Size = 4
    end
  ...
  object cdsMateriaPrima: TClientDataSet
    ...
    Left = 520
    Top = 204
    object cdsMateriaPrimaID_MATERIA: TIntegerField
      DisplayLabel = 'C'#243'digo'
      FieldName = 'ID_MATERIA'
      Required = True
    end
    object cdsMateriaPrimaNOME_MATERIA: TStringField
      DisplayLabel = 'Mat'#233'ria-Prima'
      FieldName = 'NOME_MATERIA'
      Size = 30
    end
    object cdsMateriaPrimaPERC_FIO: TFMTBCDField
      DisplayLabel = '% Fio'
      FieldName = 'PERC_FIO'
      Precision = 18
      Size = 4
