...
begin
  if Application.MessageBox('Deseja Excluir Esta Matéria-Prima ?','Confirmação',MB_ICONQUESTION+MB_YESNO ) = idyes then
  begin
...
//  Pesquisa(DM.cdsMatPrima,['NOME_MATERIA'],['Matéria-Prima'],
//    [20],'','','','','Matéria-Prima','Matéria-Prima');
end;
