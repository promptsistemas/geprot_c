...
var
  ...
  sCaixa, sTabelaPreco, sLoja : Integer;
...
var ArqINI : TIniFile;
begin
  ArqINI := TIniFile.Create(ExtractFilePath(Application.ExeName)+'PAF_ECF.INI');
...
var
  ...
  aux : String;
begin
  aux := ExtractFilePath(Application.ExeName)+'PAF_ECF.INI';
