...
type
  TfrmMenu = class(TForm)
    ...
    ReativarNotas1: TMenuItem;
    EntradaNotaFiscal1: TMenuItem;
    N35: TMenuItem;
    NotaFiscalMalharia1: TMenuItem;
    N36: TMenuItem;
    ProgramaoTinturaria2: TMenuItem;
    N37: TMenuItem;
    abeladeFretes1: TMenuItem;
    ...
    procedure inturaria2Click(Sender: TObject);
    procedure Fechamento1Click(Sender: TObject);
    procedure EntradaNotaFiscal1Click(Sender: TObject);
    procedure NotaFiscalMalharia1Click(Sender: TObject);
    procedure ProgramaoTinturaria2Click(Sender: TObject);
    procedure abeladeFretes1Click(Sender: TObject);
  private
...
uses uDM, uCadFor, uCadGrupo, uCadPro, uEntradaProduto, uConsultaEstoque,
  ...
  uFechamento, uReativaProducao, uReativaRemessa, uReativaPrgTinturaria,
  uTabelaFretes;
...
procedure TfrmMenu.abeladeFretes1Click(Sender: TObject);
begin
  if frmTabelaFretes = nil then
  begin
    frmTabelaFretes := TfrmTabelaFretes.Create(Application);
    frmTabelaFretes.ShowModal;
  end;
end;
...
procedure TfrmMenu.EntradaNotaFiscal1Click(Sender: TObject);
begin
  if frmReativaProducao = nil then
  begin
    frmReativaProducao := TfrmReativaProducao.Create(Application);
    frmReativaProducao.ShowModal;
  end;
end;
...
begin
  ...
  begin
    frmFechamento := TfrmFechamento.Create(Application);
...
procedure TfrmMenu.inturaria2Click(Sender: TObject);
begin
...
procedure TfrmMenu.NotaFiscalMalharia1Click(Sender: TObject);
begin
  if frmReativaRemessa = nil then
  begin
    frmReativaRemessa := TfrmReativaRemessa.Create(Application);
    frmReativaRemessa.ShowModal;
  end;
end;
...
begin
  ...
  StatusBar1.Panels.Items[1].Text :='Usuário: '+recInformacoes.nm_Usuario;
...
procedure TfrmMenu.ProgramaoTinturaria2Click(Sender: TObject);
begin
  if frmReativaPrgTinturaria = nil then
  begin
    frmReativaPrgTinturaria := TfrmReativaPrgTinturaria.Create(Application);
    frmReativaPrgTinturaria.ShowModal;
  end;
end;
