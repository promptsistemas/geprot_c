...
begin
    ...
    begin
      ...
      begin
        ShowMessage('Não Será Gerado Valor Complementar. Produto Não Cadastrado na Tabela de Preço Malharia.');
        Exit;
      end
      else
      begin
...
begin
  ...
  cdsContasPagar.Params[3].AsInteger := DM.cdsRemessaProducaoNR_NOTA_FISCAL.AsInteger;
