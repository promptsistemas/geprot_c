object frmCadPlanosPagto: TfrmCadPlanosPagto
  Left = 404
  Top = 175
  ...
  object PCUPOM: TPanel
    ...
    object DBEdit3: TDBEdit
      ...
      CharCase = ecUpperCase
      Ctl3D = False
      DataField = 'QT_DIAS_ENTRE_PARCELAS'
      DataSource = DM.dsPlanoPagamento
      ParentCtl3D = False
      TabOrder = 2
      OnKeyPress = FormKeyPress
    ...
    object DBEdit4: TDBEdit
      ...
      CharCase = ecUpperCase
      Ctl3D = False
      DataField = 'QT_DIAS_PRIMEIRA_PARCELA'
      DataSource = DM.dsPlanoPagamento
      ParentCtl3D = False
      TabOrder = 3
      OnKeyPress = FormKeyPress
  ...
  object BB_CANCELAR: TBitBtn
    ...
    OnMouseActivate = BB_CANCELARMouseActivate
  end
