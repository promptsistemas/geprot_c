...
{  Pesquisa(DM.cdsQuebra,['NOME_MALHARIA','NR_NOTA_FISCAL','CLIENTE','DT_EMISSAO'],['Malharia','Nº Nota','Cliente','Data Emissão'],
...
{  DM.cdsArtigo.Close;
  ...
  begin
    ...
    cdsDinamicaFios.CommandText :=  ' SELECT D.ID_PRODUCAO, P.NR_NOTA_FISCAL, P.NR_NF_REMESSA, D.ID_MATERIA_PRIMA, M.NOME_MATERIA, '+
                                    ...
                                    ' WHERE D.SALDO >0 '+
                                    ' AND D.ID_CLIENTE = '+DM.cdsQuebraID_CLIENTE.AsString;
