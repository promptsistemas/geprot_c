object frmPrecoTinturaria: TfrmPrecoTinturaria
  Left = 404
  Top = 175
  ...
  object PCUPOM: TPanel
    ...
    object DBEdit1: TDBEdit
      ...
      DataSource = DM.dsPrecoTinturaria
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
  ...
  object Panel1: TPanel
    ...
    object Label5: TLabel
      ...
      Width = 326
      Height = 32
      Caption = 'TABELA PRE'#199'O-TINTURARIA'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -24
      Font.Name = 'Segoe UI'
  ...
  object P_PRODUTOS: TPanel
    ...
    object DBEdit3: TDBEdit
      ...
      Ctl3D = False
      DataField = 'ID_ARTIGO'
      DataSource = DM.dsArtigoTinturaria
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -11
  ...
  object P_BOTOES2: TPanel
    ...
    object BB_NOVO2: TBitBtn
      ...
      NumGlyphs = 2
      TabOrder = 0
      OnClick = BB_NOVO2Click
    end
    object BB_ALTERAR2: TBitBtn
      Left = 3
      Top = 35
      Width = 75
      Height = 25
      ...
      TabOrder = 1
      Visible = False
      OnClick = BB_ALTERAR2Click
    end
    object BB_CANCELAR2: TBitBtn
      Left = 3
      Top = 35
      Width = 75
      Height = 25
      ...
      NumGlyphs = 2
      TabOrder = 2
      OnClick = BB_CANCELAR2Click
    end
    object BB_GRAVAR2: TBitBtn
      Left = 3
      Top = 61
      Width = 75
      Height = 25
      ...
      NumGlyphs = 2
      TabOrder = 3
      OnClick = BB_GRAVAR2Click
    end
    object BB_EXCLUIR2: TBitBtn
      Left = 3
      Top = 86
      Width = 75
      Height = 25
  ...
  object P_CORES_B: TPanel
    ...
    object BB_CANCELA: TBitBtn
      ...
      NumGlyphs = 2
      TabOrder = 2
      OnClick = BB_CANCELAClick
    end
    object BB_SALVA: TBitBtn
      Left = 3
      Top = 61
      Width = 75
      Height = 25
      ...
      NumGlyphs = 2
      TabOrder = 3
      OnClick = BB_SALVAClick
    end
    object BB_EXCLUI: TBitBtn
      Left = 3
      Top = 86
      Width = 75
      Height = 25
  ...
  object DBGrid2: TDBGrid
    ...
    Ctl3D = False
    DataSource = DM.dsCoresTinturaria
    DrawingStyle = gdsClassic
    FixedColor = 12053503
    GradientEndColor = clWhite
    GradientStartColor = clBlue
  ...
  object Panel4: TPanel
    ...
    TabOrder = 19
    Visible = False
    object QR_TINTURARIA: TQuickRep
      Left = 43
      Top = -132
      Width = 794
      Height = 1123
      ShowingPreview = False
      DataSet = DM.cdsArtigoTinturaria
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
  ...
  object P_SERVICO_B: TPanel
    ...
    object BB_CANC_SERV: TBitBtn
      ...
      NumGlyphs = 2
      TabOrder = 2
      OnClick = BB_CANC_SERVClick
    end
    object BB_SALVA_SERV: TBitBtn
      Left = 3
      Top = 61
      Width = 75
      Height = 25
      ...
      NumGlyphs = 2
      TabOrder = 3
      OnClick = BB_SALVA_SERVClick
    end
    object BB_EXC_SERV: TBitBtn
      Left = 3
      Top = 86
      Width = 75
      Height = 25
  ...
  object DBGrid3: TDBGrid
    ...
    Color = clMoneyGreen
    Ctl3D = False
    DataSource = DM.dsServicoTinturaria
    FixedColor = clSilver
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clNavy
    Font.Height = -11
  ...
  object qMateriaPrima: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'FROM TB_ARTIGO A'
        ...
        'WHERE NOT EXISTS(SELECT IP.ID_ARTIGO FROM TB_ITEM_PRECO_MALHARIA' +
        ' IP'
      
        '                 WHERE IP.ID_ARTIGO = A.ID_ARTIGO AND IP.ID_PREC' +
        'O_MALHARIA = :ID_ARTIGO)')
    SQLConnection = DM.conexao
    Left = 456
    Top = 260
    object qMateriaPrimaID_ARTIGO: TIntegerField
      FieldName = 'ID_ARTIGO'
      Required = True
    end
    object qMateriaPrimaNOME_ARTIGO: TStringField
      FieldName = 'NOME_ARTIGO'
      Size = 30
    end
  end
  ...
  object cdsMateriaPrima: TClientDataSet
    ...
    Left = 520
    Top = 260
    object cdsMateriaPrimaID_ARTIGO: TIntegerField
      DisplayLabel = 'C'#243'digo'
      FieldName = 'ID_ARTIGO'
      Required = True
    end
    object cdsMateriaPrimaNOME_ARTIGO: TStringField
      DisplayLabel = 'Artigo'
      FieldName = 'NOME_ARTIGO'
      Size = 30
    end
