object frmQuebraFio: TfrmQuebraFio
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsNone
  ...
  object qContasPagar: TSQLDataSet
    CommandText = 
      ...
      '= :DT_EMISSAO'#13#10'AND CP.ID_FORNECEDOR  = :ID_FORNECEDOR'#13#10'AND CP.TP' +
