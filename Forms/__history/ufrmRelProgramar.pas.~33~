...
type
  TfrmRelProgramar = class(TForm)
    ...
    QRLabel19: TQRLabel;
    qProgramarDT_PROGRAMADO: TDateField;
    cdsProgramarDT_PROGRAMADO: TDateField;
...
begin
  Ssql := ' SELECT  F.NOME AS TINTURARIA, M.NOME AS MALHARIA, MP.NOME_MATERIA as ARTIGO, RP.NR_NF_REMESSA, RP.DT_EMISSAO,PRP.DT_EMISSAO AS DT_PROGRAMADO, PRP.ID_FOR_TINTURARIA, '+
  ...
  begin
     cdsProgramar.Close;
     cdsProgramar.CommandText := Ssql+ ' GROUP BY  M.NOME , MP.NOME_MATERIA, RP.NR_NF_REMESSA, RP.DT_EMISSAO, C.R_SOCIAL, PRP.DT_EMISSAO, F.NOME,PRP.DT_EMISSAO, PRP.ID_FOR_TINTURARIA  ';
     cdsProgramar.Open ;
  ...
  begin
     ...
     cdsProgramar.CommandText := Ssql+ ' WHERE C.ID_GRUPO_EMPRESA = '+QuotedStr(edtCli.Text)+
      ' GROUP BY  M.NOME , MP.NOME_MATERIA, RP.NR_NF_REMESSA, RP.DT_EMISSAO, C.R_SOCIAL, PRP.DT_EMISSAO, F.NOME,PRP.DT_EMISSAO,  PRP.ID_FOR_TINTURARIA  ';
     cdsProgramar.Open ;
