object frmContasPagarLista: TfrmContasPagarLista
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'frmContasPagarLista'
  ClientHeight = 614
  ClientWidth = 983
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Width = 983
    Height = 240
    Hint = 'Duplo clique para exibir informa'#231#245'es do T'#237'tulo'
    Align = alTop
  ...
  object P_valores: TPanel
    ...
    object EdtValorParcial: TEdit
      ...
      ReadOnly = True
      TabOrder = 1
      Text = 'EdtValorParcial'
    end
  end
  object P_INFORMACOES: TPanel
    Left = 0
    Top = 433
    Width = 743
    Height = 181
    ...
    object Panel9: TPanel
      ...
      Height = 32
      Align = alTop
      Caption = 'INFORMA'#199#213'ES DO T'#205'TULO'
      Color = clBlue
      Font.Charset = ANSI_CHARSET
      Font.Color = clYellow
      Font.Height = -15
  ...
  object P_BAIXA_LOTE: TPanel
    ...
    object Label19: TLabel
      ...
      Width = 249
      Height = 18
      Caption = 'Valor Total dos Registros Selecionados'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -15
      Font.Name = 'Tahoma'
    ...
    object Label22: TLabel
      ...
      Width = 246
      Height = 18
      Caption = 'Quantidade de Registros Selecionados'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -15
      Font.Name = 'Tahoma'
  ...
  object cdsContasPagar: TClientDataSet
    ...
    object cdsContasPagarOBS: TStringField
    ...
    object cdsContasPagarFORN_REMESSA: TStringField
      DisplayLabel = 'Fornecedor Remessa'
      FieldName = 'FORN_REMESSA'
      ProviderFlags = []
      Size = 50
    end
    ...
    object cdsContasPagarDIAS_ATRASO: TIntegerField
  ...
  object qContasPagar: TSQLDataSet
    CommandText = 
      ...
      'NR_NF_REMESSA,'#13#10'    CP.ORIGEM,'#13#10'    CP.VL_PAGO,'#13#10'    CP.OBS,'#13#10'  ' +
      '  CP.TP_MOV,'#13#10'    PP.DESCRICAO_PAGAMENTO,'#13#10'    C.R_SOCIAL AS CLI' +
      'ENTE ,'#13#10'    F.NOME AS FORNECEDOR  ,'#13#10'    FR.NOME AS FORN_REMESSA' +
      ','#13#10'    U.NOME_USUARIO         ,'#13#10'    L.R_SOCIAL AS EMPRESA,'#13#10'   ' +
      ' (current_date - CP.DT_VENCIMENTO) AS DIAS_ATRASO'#13#10'FROM TB_CONTA' +
      'S_PAGAR CP'#13#10'JOIN TB_PLANO_PAGAMENTO PP ON (PP.ID_PLANO_PAGAMENTO' +
      ' = CP.ID_PLANO_PAGAMENTO)'#13#10'JOIN TB_CLIENTE C ON (C.ID_CLIENTE = ' +
      'CP.ID_CLIENTE)'#13#10'JOIN TB_FORNECEDOR F ON (F.ID_FORNECEDOR = CP.ID' +
      '_FORNECEDOR)'#13#10'JOIN TB_FORNECEDOR FR ON (FR.ID_FORNECEDOR = CP.ID' +
      '_FORN_REM)'#13#10'JOIN TB_USUARIO U ON (U.ID_USUARIO = CP.ID_USUARIO)'#13 +
      #10'JOIN TB_LOJAS L ON (L.ID_LOJA = CP.ID_LOJA)'#13#10'ORDER BY CP.DT_VEN' +
      'CIMENTO'
    MaxBlobSize = -1
    Params = <>
    ...
    object qContasPagarVL_PAGO: TFMTBCDField
      FieldName = 'VL_PAGO'
      Precision = 18
      Size = 3
    end
    object qContasPagarOBS: TStringField
      FieldName = 'OBS'
      Size = 255
    end
    ...
    object qContasPagarDIAS_ATRASO: TIntegerField
      FieldName = 'DIAS_ATRASO'
      ProviderFlags = []
    end
  ...
  object qFornecedor: TSQLDataSet
    CommandText = 
      'SELECT'#13#10' F.ID_FORNECEDOR,'#13#10' F.CODIGO_MUNIC,'#13#10' F.DT_CADASTRO,'#13#10' F' +
      '.NOME,'#13#10' F.TP_LOGRADOURO,'#13#10' F.ENDERECO,'#13#10' F.COMPLEMENTO,'#13#10' F.NUM' +
      'ERO,'#13#10' F.BAIRRO,'#13#10' F.CEP,'#13#10' F.TELFONE,'#13#10' F.FAX,'#13#10' F.CELULAR,'#13#10' F' +
      '.EMAIL,'#13#10' F.CNPJ,'#13#10' F.INS_EST,'#13#10' F.CONTATO,'#13#10' F.SITE,'#13#10' F.FANTAS' +
      'IA,'#13#10' F.SITUACAO,'#13#10' F.DT_ABERTURA,'#13#10' F.CNAE_PRINCIPAL,'#13#10' F.CNAE_' +
      'SECUNDARIO,'#13#10' F.ID_CATEGORIA,'#13#10' M.NOME AS CIDADE,'#13#10' M.UF AS UF,'#13 +
      #10' M.DDD,'#13#10' C.NOME_CATEGORIA'#13#10'FROM TB_FORNECEDOR F'#13#10'JOIN TB_MUNIC' +
      'IPIOS M ON (M.CODIGO_MUNIC = F.CODIGO_MUNIC)'#13#10'LEFT JOIN TB_CATEG' +
      'ORIA  C ON (C.ID_CATEGORIA = F.ID_CATEGORIA)'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.conexao
    Left = 427
